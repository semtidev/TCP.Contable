<html lang="en">
    <head>
        ...
        <style>
            ...
            .table_rules { border: #333 1px solid; margin: 50px auto 0 auto; width: 95%; }
            ...
            .tablesubtitle { text-align: center; padding: 2px 5px; text-transform: uppercase; font-size: 10px; font-weight: 700; }
            .help { text-align: center; font-size: 12px; }
            .data { font-size: 11px; padding: 2px 5px; }
            .cell-mark { 
