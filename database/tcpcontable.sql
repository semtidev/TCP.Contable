...
Source Database       : tcpcontable

Target Server Type    : MYSQL
Target Server Version : 50719
File Encoding         : 65001

Date: 2020-04-14 07:25:46
*/
...
CREATE TABLE `acnt_accounts` (
  ...
  `code_parent` varchar(20) NOT NULL,
...
CREATE TABLE `aft_products` (
  ...
  `um` varchar(191) DEFAULT NULL,
  `ctdad` int(10) DEFAULT NULL,
  `price` decimal(10,2) DEFAULT NULL,
  `import` decimal(10,2) DEFAULT NULL,
  `pay_date` date DEFAULT NULL,
  `live_year` decimal(10,2) DEFAULT NULL,
  `dep_year` varchar(191) DEFAULT NULL,
  `dep_month` varchar(191) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `entries` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_tcp` int(10) unsigned DEFAULT NULL,
...
INSERT INTO `entries` VALUES ('23', '1', '2020-01-01', '4224.00', '0.00', null, '2020-01-25 08:34:36', '2020-01-25 13:34:36');
...
INSERT INTO `entries` VALUES ('33', '1', '2020-01-10', '1400.00', '0.00', null, '2020-03-01 11:14:03', '2020-03-01 11:14:03');
...
INSERT INTO `expenses` VALUES ('6', '1', '2020-01-01', '1.00', '2.00', '3.00', '4.00', '5.00', '34234.00', null, null, null, null, null, null, null, null, null, null, null, '34249.00', null, null, '2020-01-13 15:55:37', '2020-01-27 02:20:47');
...
INSERT INTO `expenses` VALUES ('8', '1', '2020-01-02', '6.00', '5.00', '8.00', '9.00', '10.00', null, null, null, null, null, null, null, null, null, null, null, null, '38.00', null, null, '2020-01-25 17:39:09', '2020-01-27 02:44:13');
...
CREATE TABLE `expenses_columns` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_tcp` int(10) unsigned NOT NULL,
  `col7` varchar(191) DEFAULT '',
  `col8` varchar(191) DEFAULT '',
  `col9` varchar(191) DEFAULT '',
  `col10` varchar(191) DEFAULT '',
  `col11` varchar(191) DEFAULT '',
  `col12` varchar(191) DEFAULT '',
  `col17` varchar(191) DEFAULT '',
  `col18` varchar(191) DEFAULT '',
  `col19` varchar(191) DEFAULT '',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `expenses_columns` VALUES ('1', '1', 'Renta', '', '', '', '', '', '', '', '');
...
CREATE TABLE `obligations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `obligation` varchar(191) DEFAULT NULL,
...
CREATE TABLE `tcp` (
  ...
  `ci` varchar(191) DEFAULT NULL,
  `nit` varchar(191) NOT NULL,
  `act_code` varchar(191) NOT NULL,
  `act_desc` varchar(191) NOT NULL,
  `workers` varchar(191) DEFAULT NULL,
  `address` varchar(191) DEFAULT NULL,
  `address_company` varchar(191) DEFAULT NULL,
  `province_company` int(10) unsigned DEFAULT NULL,
  `city_company` int(10) unsigned DEFAULT NULL,
