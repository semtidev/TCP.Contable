...
(function() {
    ...
    ajax.open("POST", "./php/sistema/systemstart.php?var=myrand",true);
    ajax.onreadystatechange=function() {        
        if (ajax.readyState==4){ if(ajax.responseText == 'false'){ window.location = 'login'; }}        
    }
    ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    ajax.send("action=checksession");
